...
session(s(3),[q(06),q(07),q(08)],[all]).
session(s(4),[q(09)],[]).


fluents([
    isAt(p)~[farmhouse_kitchen,barn_fields,shopping_centre,sand,city],
    age(p)~[around_10_20,around_30_40,around_60_70,around_70_80,around_20_50],
    has_type(p)~[sheep_dog,slate_dog,hound_dog,guide_dog],
